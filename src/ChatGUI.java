...
public class ChatGUI extends JFrame {
	...
	private JMenuItem alienSkin;
	private JMenuItem devilSkin;
	private JMenuItem ghostSkin;
...
//****************************************************************************************
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource() == contactUs) {
					...
					try {
						...
						alienIcon = new ImageIcon(getClass().getResource("/alien.png"));
					}
					...
					JOptionPane.showMessageDialog(null,
						...
						"****************\n" +
						"tel:                    0875331254\n" +
						"email:              alien_chat@gmail.com\n" +
						"facebook:       Alien Chat Ltd\n",
						"Alien Chat Contact",
						JOptionPane.INFORMATION_MESSAGE, alienIcon);
				}
			}
		});
		...
		//Add Action Listener to the Devil Skin Menu Item
		devilSkin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				//Change the skin to the Devil Skin
				if (e.getSource() == devilSkin) {
					applyDevilSkin();
				}
			}
		});

		//Add Action Listener to the Alien Skin Menu Item
		alienSkin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				//Changet the skin to the Alien Skin
				if (e.getSource() == alienSkin) {
					applyAlienSkin();
				}
			}
		});

		//Add Action Listener to the Ghost Skin Menu Items
		ghostSkin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				//Change the skin to the Ghost Skin
				if (e.getSource() == ghostSkin) {
					applyGhostSkin();
				}
			}
		});
...
//****************************************************************************************
	...
	public void createMenuBar() {
		...
		devilSkin = new JMenuItem("Devil Skin");
		ghostSkin = new JMenuItem("Ghost Skin");
		alienSkin = new JMenuItem("Alien Skin");
		...
		changeSkin.add(alienSkin);
		changeSkin.add(devilSkin);
		changeSkin.add(ghostSkin);
	...
	public void addAcceleratorKeys() {
		...
		alienSkin.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.CTRL_MASK));
		devilSkin.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.CTRL_MASK));
		ghostSkin.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G, ActionEvent.CTRL_MASK));
	}
...
//****************************************************************************************
	...
	public void buildPanel() {
		...
		welcomeLabel.setText("Welcome to the Alien Chat");
		usernameLabel = new JLabel();
		usernameLabel.setPreferredSize(new Dimension(320, 20));
		usernameLabel.setHorizontalAlignment(SwingConstants.RIGHT);
		footerLabel = new JLabel();
		footerLabel.setText("Ardeja Ltd " + COPY_SYMBOL + " Copyright 2016");
